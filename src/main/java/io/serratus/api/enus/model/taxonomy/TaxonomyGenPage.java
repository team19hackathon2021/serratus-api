 ...
 * Map.hackathonMissionGen: to create the a new base Java backend class to render the page for taxonomies related to RNA seqence runs. 
 * Map.hackathonColumnGen: Develop Taxonomy UI
