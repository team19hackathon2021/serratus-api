...
import io.serratus.api.enus.user.SiteUserGenPage;
...
/**	
 * Map.hackathonMission: to create the a new Java backend class to render the page for site users. 
 * Map.hackathonColumn: Develop SiteUser UI
 * Map.hackathonLabels: Java,Vert.x,Handlebars
 * <br/><a href="http://localhost:8983/solr/computate/select?q=*:*&fq=partEstClasse_indexed_boolean:true&fq=classeNomCanonique_enUS_indexed_string:io.serratus.api.enus.user.SiteUserPage&fq=classeEtendGen_indexed_boolean:true">Find the class  in Solr. </a>
 * <br/>
 **/
